    ...
    try:
        for split_number in range(10):
            ...
            if MODEL_NAME in ['RingGNN', '3WLGNN']:
                # import train functions specific for GNNs using dense tensors
                from train.train_all_data_task_dense_gnn import train_epoch_TUs as train_epoch, evaluate_network_TUs as evaluate_network
                ...
                from train.train_TUs_graph_classification import train_epoch, evaluate_network
