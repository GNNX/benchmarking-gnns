    ...
    try:
        for split_number in range(5):
            ...
            if MODEL_NAME in ['RingGNN', '3WLGNN']:
                ...
                from train.train_all_data_task_dense_gnn import train_epoch_CSL as train_epoch, evaluate_network_CSL as evaluate_network
                ...
                from train.train_CSL_graph_classification import train_epoch, evaluate_network
